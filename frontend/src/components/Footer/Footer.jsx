    ...
    <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                ...
                <p className='font-bold text-xl'>FreeLanza</p>
                <p className="text-base leading-relaxed text-gray-600 mt-7">A dynamic platform where employers can post job opportunities and
          connect with skilled freelancers. Browse profiles, review portfolios,
          and hire the right talent for your projects.</p>

                <ul className="flex items-center space-x-3 mt-9">
                    <li>
                        <a href="https://www.instagram.com/parthbelose/" title="" className="flex items-center justify-center text-white transition-all duration-200 bg-gray-800 rounded-full w-7 h-7 hover:bg-blue-600 focus:bg-blue-600">
                    ...
                    <li>
                        <a href="https://github.com/divyannshu/SIH-2024-CodeCrafters-" title="" className="flex items-center justify-center text-white transition-all duration-200 bg-gray-800 rounded-full w-7 h-7 hover:bg-blue-600 focus:bg-blue-600">
                            <svg className="w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                                <path
                                    fillRule="evenodd"
                                    clipRule="evenodd"
            ...
            <div>
                ...
                <ul className="mt-6 space-y-4">
                    ...
                    <li>
                        <a href="/job" title="" className="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Works </a>
                    </li>

                    <li>
                        <a href="/profile" title="" className="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Profile </a>
                    </li>
                </ul>
            </div>
        ...
        <p className="text-sm text-center text-gray-600">© Copyright 2024, All Rights Reserved by FreeLanza</p>
    </div>
</section>
