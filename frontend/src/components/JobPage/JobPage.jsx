    ...
    <section className="relative py-12 sm:py-16 lg:pb-40">
        ...
        <div className="relative px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 gap-y-4 lg:items-center lg:grid-cols-2 xl:grid-cols-2">
                ...
                <h1 className="text-4xl font-bold leading-tight text-gray-900 sm:text-5xl sm:leading-tight lg:text-6xl lg:leading-tight font-pj">{Job.company}</h1>
                    <h2 className="text-4xl font-bold leading-tight text-gray-900 sm:text-5xl sm:leading-tight lg:text-4xl lg:leading-tight font-pj">{Job.jobTitle}</h2>
                    <p className="mt-2 text-lg text-gray-600 sm:mt-6 font-inter">{Job.jobDescription}</p>
                    ...
                    <div className="mt-8 sm:mt-16">
                        <blockquote className="mt-6">
                            ...
                            <p className="mt-3 text-base leading-7 text-gray-600 font-inter">{Job.companyDescription}</p>
                        </blockquote>
                    </div>
                </div>
