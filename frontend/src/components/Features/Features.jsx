...
const Features = () => {        
 ...
 <g transform="translate(0 -1028.4)">
  ...
  <path d="m12 1032.4v16c4.175-1.6 7-4.6 7-8v-8h-7z" fill="#2ecc71"/>
  <path d="m16 1037.4-4.683 4.6-1.9511-1.9-1.6586 1.7 1.9512 1.9 1.5615 1.6 0.097 0.1 6.342-6.4-1.659-1.6z" fill="#27ae60"/>
  <path d="m16 1036.4-4.683 4.6-1.9511-1.9-1.6586 1.7 1.9512 1.9 1.5615 1.6 0.097 0.1 6.342-6.4-1.659-1.6z" fill="#ecf0f1"/>
            ...
            <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200">
                ...
                <h3 className="mt-12 text-xl font-bold text-gray-900 font-pj">AI-Powered Job and Talent Recommendations</h3>
                <p className="mt-5 text-base text-gray-600 font-pj">Experience smarter connections with our AI-powered system that recommends the best jobs for freelancers and the most suitable talents for clients, tailored to your preferences and skills.</p>
            </div>
            ...
            <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200">
                ...
                <h3 className="mt-12 text-xl font-bold text-gray-900 font-pj">Client and Freelancer Messaging</h3>
                <p className="mt-5 text-base text-gray-600 font-pj">Communicate effectively with clients or freelancers using our real-time messaging system, keeping all project discussions in one place.</p>
            </div>
            ...
            <div className="md:p-8 lg:p-14 md:border-t md:border-gray-200">
                ...
                <h3 className="mt-12 text-xl font-bold text-gray-900 font-pj"> Advanced Filter and Search Options</h3>
                <p className="mt-5 text-base text-gray-600 font-pj">Find the perfect freelance projects or candidates with our advanced filtering options, allowing you to search by skills, experience, location, and more.</p>
            </div>
            ...
            <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200 md:border-t">
                ...
                <h3 className="mt-12 text-xl font-bold text-gray-900 font-pj">User Login with JWT Authentication</h3>
                <p className="mt-5 text-base text-gray-600 font-pj">Provide a secure and convenient login experience using JWT (JSON Web Token) authentication, ensuring safe access and protecting user data.</p>
            </div>
            ...
            <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200 md:border-t">
                ...
                <h3 className="mt-12 text-xl font-bold text-gray-900 font-pj">Freelancer Connect</h3>
                <p className="mt-5 text-base text-gray-600 font-pj">Join a vibrant community of freelancers to network, share knowledge, collaborate on projects, and help each other grow professionally.</p>
            </div>
        </div>
    </div>
</section>
